...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-lg-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 my-3">
            ...
            <span class="mx-1"><i class="fas fa-circle text-secondary"></i> @lang('otros')</span>
        </div>
        <div class="row header-calendar mt-3"  >
          <div class="col" style="display: flex; justify-content: space-between; padding: 10px;">
            ...
            <h2 style="font-weight:bold;margin:10px;"><?= $mespanish; ?> <small><?= $data['year']; ?>
                    @auth
                        @if (auth()->user()->role===3 || auth()->user()->role===1)
                            <a class="btn" href="{{ asset('/evento/form') }}"><i class="far fa-calendar-plus"></i></a>
                        @endif
                    @endauth
                </small>
            </h2>
            ...
            @foreach  ($weekdata['datos'] as $dayweek)
                ...
                <div class="col-12 col-lg box-day">
                    ...
                    @foreach  ($dayweek['evento'] as $event)
                        ...
                        @elseif ($event->tipo==2) class="badge badge-success" title="@lang('noticia')"
                        @else class="badge badge-secondary" title="@lang('otros')"
                        @endif
